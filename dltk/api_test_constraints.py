...
from .api_test_check_artifact_safety import scan as scan_secrets
from .api_test_design_rules import understanding_errors
...
MOCK_DATA_NAMESPACE_ENV = "DLTK_DATA_NAMESPACE"
...
def mock_data_ready_env(case_id: str) -> str:
    ...
    return f"DLTK_MOCK_DATA_READY_{suffix or 'CASE'}"
