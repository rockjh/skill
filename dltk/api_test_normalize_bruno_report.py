...
from .api_test_check_api_coverage import execution_evidence
    ...
    for item in items:
        ...
        for key in ("assertionResults", "testResults"):
            ...
            for observation in observations:
                ...
                if status not in {"pass", "passed", "success"} or not label.startswith("dltk:flow:"):
                    continue
                kind, _, value = label[len("dltk:flow:"):].partition(":")
