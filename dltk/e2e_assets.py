...
# 可构造性：每个前置和步骤都必须穷尽十类控制路径；写入探针必须引用正式隔离与清理符号。
constructability:
  preconditions:
    - id: <precondition-symbol>
      ...
      candidates: &candidate-matrix
        - {kind: public_api, status: usable, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: write, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: scenario-local, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: test_or_admin_api, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: database_control, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: messages, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: scheduled_jobs, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: mocks_and_faults, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: dynamic_configuration, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: existing_test_data, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: <control-symbol>, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: database_read, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: database_read, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
        - {kind: observability, status: not_found, component: <component>, consumer_source: <repository-id>#<source-anchor>, control: observability, side_effect: none, trigger: <trigger-symbol>, observation: <observation-symbol>, isolation: <owned-correlation>, cleanup: <cleanup-action>, impact: none, recovery: <recovery-symbol>, evidence: [<repository-id>#<source-anchor>]}
  steps:
    - step_id: <step-id>
      candidates: *candidate-matrix
...
RUN_BAT = '''@echo off
dltk e2e run --project "%~dp0" %*
'''

RUN_SH = '''#!/usr/bin/env sh
set -eu
project_root=$(CDPATH= cd -P -- "$(dirname -- "$0")" && pwd)
exec dltk e2e run --project "$project_root" "$@"
'''
