...
from .e2e_contracts import CONTROL_NAMES, _expectation_field, _lookup_value, contract_errors
...
from .e2e_source_versions import source_version_results
from .e2e_static_checks import (
    _call_argument,
    _import_aliases,
    _resolved_call_name,
    static_errors,
...
def run_ordered(project_root: Path, scenario: str | None, pytest_args: list[str], *, static_only: bool) -> int:
    ...
    checker = [sys.executable, "-m", "dltk", "e2e", "check", "--project", str(project_root)]
    ...
    source_code = _run([
        sys.executable, "-m", "dltk", "e2e", "source-status", "--project", str(project_root), *selector,
    ], project_root, environment)
    ...
    from . import e2e_runtime as runtime_module
    business_code = 0
