...
SCENARIO_SCHEMA: dict[str, Any] = {
    ...
    "machine_gate": "dltk e2e check --gate contracts",
}
...
WORKSPACE_SCHEMA: dict[str, Any] = {
    ...
    "machine_gate": "dltk e2e check --gate discovery",
}
...
CONFIG_SCHEMA: dict[str, Any] = {
    ...
    "machine_gate": "dltk e2e check --gate static",
}
...
E2E_VERSION_LOCK_SCHEMA: dict[str, Any] = {
    ...
    "document": _object({
        "version": {"const": 1},
        "tool": _object({"name": {"const": "dltk"}, "version": NONEMPTY_STRING, "e2e_schema": {"const": E2E_GATE_SCHEMA_VERSION}}),
