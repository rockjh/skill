...
The generated launchers are thin convenience assets and call `dev-ai api-test run --qa-root ...`; they contain no Python implementation. `dev-ai api-test scripts` reports the installed domain schema and does not synchronize files.
