...
```bash
dev-ai api-test scripts version-check --qa-root qa --phase before-generate
dev-ai api-test scripts version-check --qa-root qa --phase before-execute
dev-ai api-test scripts version-complete --qa-root qa --completion-report qa/results/<strict-report>.json --tests-adapted
```
