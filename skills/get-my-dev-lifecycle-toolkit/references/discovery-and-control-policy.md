...
Every non-static `dltk e2e run` requires `runtime_probe.requested: true` and `outcome: completed`; do not infer absence from an unset E2E variable. Probe read-only:
