...
`dev-ai e2e source-status` discovers `scenarios/*/场景定义.yaml` directly and resolves repository IDs through discovery. It accepts optional exact `--scenario <中文场景名称>`; unknown, ambiguous, or path-like values are errors.
