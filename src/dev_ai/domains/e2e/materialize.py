...
def _test_source(name: str, definition: Mapping[str, Any]) -> str:
    ...
    lines = [
        ...
        "from pathlib import Path",
        "import pytest",
        "from dev_ai.domains.e2e.runtime import assert_business_expectations, cleanup_scenario, invoke_protocol, poll_until, preflight, record_business_entry, report_control_gap, step_guard",
        "",
        "",
        "def _project_root():",
        '    """定位生成工程根目录。"""',
